...
TextHistory.prototype.getVersionList = function() {
  return idsMappedToIndexes;
}

/**
 *
 * @param id {string} version id returned in .addVersion()
 * @returns {boolean} whether the version is in the history
 */
TextHistory.prototype.hasVersion = function(id) {
  return this.idsMappedToIndexes[id] !== undefined;
};
